...
//Rare exceptions to indicate a bug in the _tagnetmobile code (Eg, function that a subclass should have implemented)
...
/**
 The base class for TAGNETMobile proxies.
 */
