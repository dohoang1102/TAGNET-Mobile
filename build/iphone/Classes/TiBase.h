...
// in simulator we redefine to format for TAGNETMobile Developer console
...
{\
	NSString * exceptionName = [@"org.tagnetmobile." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tagnetmobile";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITAGNETMobileNativeItemNone = -1, 
	UITAGNETMobileNativeItemSpinner = -2,
	UITAGNETMobileNativeItemProgressBar = -3,
	
	UITAGNETMobileNativeItemSlider = -4,
	UITAGNETMobileNativeItemSwitch = -5,
	UITAGNETMobileNativeItemMultiButton = -6,
	UITAGNETMobileNativeItemSegmented = -7,
	
	UITAGNETMobileNativeItemTextView = -8,
	UITAGNETMobileNativeItemTextField = -9,
	UITAGNETMobileNativeItemSearchBar = -10,
	
	UITAGNETMobileNativeItemPicker = -11,
	UITAGNETMobileNativeItemDatePicker = -12,
	
	UITAGNETMobileNativeItemInfoLight = -13,
	UITAGNETMobileNativeItemInfoDark = -14,
	
	UITAGNETMobileNativeItemDisclosure = -15,
	
	UITAGNETMobileNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all TAGNETMobile instances of
