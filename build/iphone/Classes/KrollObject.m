 ...
 * Copyright (c) 2009-2011 by TAGNETMobile, Inc. All Rights Reserved.
...
//@interface TAGNETMobileObject : NSObject
//@end

@interface TAGNETMobileObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TAGNETMobileObject class]])
		{
			for (NSString *key in [[(TAGNETMobileObject*)o modules] allKeys])
			{
