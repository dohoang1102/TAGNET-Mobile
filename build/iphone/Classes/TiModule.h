...
/**
 The base class for all TAGNETMobile modules
 */
...
/**
 TAGNETMobile Platform calls this method on startup.
 */
-(void)startup;

/**
 TAGNETMobile Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 TAGNETMobile Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 TAGNETMobile Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 TAGNETMobile Platform calls this method on resume.
 @param sender The sender of the event.
 */
