...
@interface TAGNETMobileObject : KrollCoverageObject {
#else
@interface TAGNETMobileObject : KrollObject {
#endif
@private
...
extern NSString * TAGNETMobile$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TAGNETMobileObject *_tagnetmobile;
    KrollObject* console;
	BOOL shutdown;
