...
/**
 Base class for all TAGNETMobile views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the TAGNETMobile view hierarchy (such as wrapped iOS UIViews) was touched.
